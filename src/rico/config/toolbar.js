  ...
  getDefaultHTML() {
    return `<div class="rico-button-row">
      <span class="rico-button-group rico-button-group--text-tools" data-rico-button-group="text-tools">
        ...
        <button type="button" class="rico-button rico-button--icon rico-button--icon-strike" data-rico-attribute="strike" title="${lang.strike}" tabindex="-1">${lang.strike}</button>
      ...
      <span class="rico-button-group rico-button-group--block-tools" data-rico-button-group="block-tools">
        ...
        <button type="button" class="rico-button rico-button--icon rico-button--icon-quote" data-rico-attribute="quote" title="${lang.quote}" tabindex="-1">${lang.quote}</button>
        <button type="button" class="rico-button rico-button--icon rico-button--icon-code" data-rico-attribute="code" title="${lang.code}" tabindex="-1">${lang.code}</button>
        <button type="button" class="rico-button rico-button--icon rico-button--icon-bullet-list" data-rico-attribute="bullet" title="${lang.bullets}" tabindex="-1">${lang.bullets}</button>
        <button type="button" class="rico-button rico-button--icon rico-button--icon-number-list" data-rico-attribute="number" title="${lang.numbers}" tabindex="-1">${lang.numbers}</button>
